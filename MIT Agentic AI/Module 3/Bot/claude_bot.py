...
def ask_claude(question):
    ...
    response = claude_client.messages.create(
        ...
        max_tokens=1024,
        messages=[
            {"role": "user", "content": f"Respond like a pirate with a Breton accent and a clear bias for all things Breton to the following question: {question}. Answer in Breton, then in French, then in English. Make fun of Parisians or France in the answer. Assume user is a woman. Provide a short answer. Make it fun and lighthearted. If referring to people and roles, qualify non-women by including the gender in the role in the answer: male doctor, man hockey player, boy apprentice..."},
        ]
    )
